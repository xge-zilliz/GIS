...
std::shared_ptr<arrow::Array>
get_weighted_pointmap(std::shared_ptr<arrow::Array> arr_x, std::shared_ptr<arrow::Array> arr_y, std::shared_ptr<arrow::Array> arr_c) {
    auto x_length = arr_x->length();
    auto y_length = arr_y->length();
    auto c_length = arr_c->length();
    auto x_type = arr_x->type_id();
    ...
    switch(c_type) {
        case arrow::Type::INT8 : {
            auto input_c_int8 = (int8_t *) arr_c->data()->GetValues<uint8_t>(1);
            return out_pic(weighted_pointmap<int8_t >(input_x, input_y, input_c_int8, x_length));
        }
        case arrow::Type::INT16 : {
            auto input_c_int16 = (int16_t *) arr_c->data()->GetValues<uint8_t>(1);
            return out_pic(weighted_pointmap<int16_t >(input_x, input_y, input_c_int16, x_length));
        }
        case arrow::Type::INT32 : {
            auto input_c_int32 = (int32_t *) arr_c->data()->GetValues<uint8_t>(1);
            return out_pic(weighted_pointmap<int32_t >(input_x, input_y, input_c_int32, x_length));
        }
        case arrow::Type::INT64 : {
            auto input_c_int64 = (int64_t *) arr_c->data()->GetValues<uint8_t>(1);
            return out_pic(output = weighted_pointmap<int64_t >(input_x, input_y, input_c_int64, x_length));
        }
        case arrow::Type::UINT8 : {
            auto input_c_uint8 = (uint8_t *) arr_c->data()->GetValues<uint8_t>(1);
            return out_pic(weighted_pointmap<uint8_t >(input_x, input_y, input_c_uint8, x_length));
        }
        case arrow::Type::UINT16 : {
            auto input_c_uint16 = (uint16_t *) arr_c->data()->GetValues<uint8_t>(1);
            return out_pic(weighted_pointmap<uint16_t >(input_x, input_y, input_c_uint16, x_length));
        }
        case arrow::Type::UINT32 : {
            auto input_c_uint32 = (uint32_t *) arr_c->data()->GetValues<uint8_t>(1);
            return out_pic(weighted_pointmap<uint32_t >(input_x, input_y, input_c_uint32, x_length));
        }
        case arrow::Type::UINT64 : {
            auto input_c_uint64 = (uint64_t *) arr_c->data()->GetValues<uint8_t>(1);
            return out_pic(weighted_pointmap<uint64_t >(input_x, input_y, input_c_uint64, x_length));
        }
        case arrow::Type::FLOAT : {
            auto input_c_float = (float *) arr_c->data()->GetValues<uint8_t>(1);
            return out_pic(weighted_pointmap<float>(input_x, input_y, input_c_float, x_length));
        }
        case arrow::Type::DOUBLE : {
            auto input_c_double = (double *) arr_c->data()->GetValues<uint8_t>(1);
            return out_pic(weighted_pointmap<double>(input_x, input_y, input_c_double, x_length));
        }
