...
template class HeatMap<int16_t>;

template class HeatMap<int32_t>;

template class HeatMap<int64_t>;

template class HeatMap<uint8_t>;

template class HeatMap<uint16_t>;

template class HeatMap<uint32_t>;

template class HeatMap<uint64_t>;

template class HeatMap<float>;
